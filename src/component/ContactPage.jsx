...
const ContactPage = () => {
    ...
    function handleSubmit(e) {
        ...
        const url = `https://wa.me/7881198930?text=${encodeURIComponent(text)}`;
            ...
            <div className={contactPageStyles.gridContainer}>
                <div className={contactPageStyles.formContainer}>
                    ...
                    <p className={contactPageStyles.formSubtitle}>
                        Fill the form - we'll open on whatsapp so you can connect with us instantly.
                    </p>
                    <form className={contactPageStyles.formSpace} onSubmit={handleSubmit}>
                        ...
                        <div>
                            ...
                            <select name="service" vlaue={form.service} onChange={handleChange}
                                className={contactPageStyles.input}>
                                <option value="">
                ...
                <div className={contactPageStyles.infoContainer}>
                    <div className={contactPageStyles.infoCard}>
                        ...
                        <p className={contactPageStyles.infoText}>Rasra, Ballia, Utter Pradesh</p>
                        <p className={contactPageStyles.infoItem}>
                            <Phone size={16} /> 7881198930
                        </p>
                        <p className={contactPageStyles.infoItem}>
                            <Mail size={16} /> vsaurabh78811@gmail.com
                        </p>
                    </div>
                    <iframe
                    ...
                    <div className={contactPageStyles.hoursContainer}>
                            <h4 className={contactPageStyles.hoursTitle}>Opening Hours</h4>
