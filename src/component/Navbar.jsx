                    ...
                    <div className={navbarStyles.flexContainer}>
                        ...
                        <div className={navbarStyles.rightContainer}>
                            <SignedOut>
                                ...
                                {/* Patient login */}
                                <button className={navbarStyles.loginButton} onClick={() => clerk.openSignIn()}>
                                    <Key className={navbarStyles.patientLoginIcon}/>
                                    Login
                                </button>
                            </SignedOut>
                        ...
                        <div className={navbarStyles.mobileMenu}>
                            ...
                            <SignedOut>
                                ...
                                <div className={navbarStyles.mobileLoginContainer}>
                                    <button className={navbarStyles.mobileLoginButton} onClick={() => {setIsOpen(false); clerk.openSignIn();}}>
                                        Login
                                    </button>
                                </div>
                            </SignedOut>
